...
// new Swiper(선택자, 옵션)
new Swiper('.notice-line .swiper-container', {  // 공지사항
  direction: 'vertical',
  autoplay: true,
  loop: true
});
new Swiper('.promotion .swiper-container', {  // 프로모션
...
new Swiper('.awards .swiper-container', {  //  어워즈
  autoplay: true,
  loop: true,
  spaceBetween: 30,
  slidesPerView: 5,
...
spyEls.forEach(function (spyEl) {
  new ScrollMagic
    .Scene({
      ...
      triggerHook: .8 // 뷰포트 0 ~ 1 중 어떤 지점에서 실행할 것인지!
    })
